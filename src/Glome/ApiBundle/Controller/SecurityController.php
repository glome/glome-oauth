      ...
      public function glomeLoginAction(Request $request) {
          if ($request->isMethod('POST')) {
              if ($request->get('reload') != 1) {
                  ...
                  $glome_user = $this->forward('GlomeApiBundle:Glome:glomeLogin', array(
                      'glomeid'  => $glomeid,
                      'password' => $password,
                  ));
                  return $glome_user;

                  // return $this->redirect($this->generateUrl('/api/glomeLoginAction',
                  //   array('glomeid' => $glomeid, 'password' => $password)));
              }
          }
        ...
        return $this->render(
          'GlomeApiBundle:Glome:index.html.twig',
